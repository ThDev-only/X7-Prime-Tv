...
public class MoviesLogoConnection extends AsyncTask<String, Void, String> {

    private static final String TAG = MoviesBannerConnection.class.getSimpleName();
    private TheMovieDatabase.getUrlLogo listener;
    private String page;

    public MoviesLogoConnection(String page, TheMovieDatabase.getUrlLogo listener) {
        this.page = page;
