...
public class DatabaseMemory {
    ...
    public DatabaseMemory(Context appContext) {
     ...
     */
    public ArrayList<Integer> getArrListInt(String key) {
     ...
     */
    public ArrayList<Double> getArrListDouble(String key) {
        String[] myList = TextUtils.split(preferences.getString(key, ""), "‚‗‚");
        ArrayList<String> arrayToList = new ArrayList<String>(Arrays.asList(myList));
     ...
     */
    public ArrayList<Long> getArrListLong(String key) {
        String[] myList = TextUtils.split(preferences.getString(key, ""), "‚‗‚");
        ArrayList<String> arrayToList = new ArrayList<String>(Arrays.asList(myList));
     ...
     */
    public ArrayList<String> getArrListString(String key) {
     ...
     */
    public ArrayList<Boolean> getArrListBoolean(String key) {
        ArrayList<String> myList = getArrListString(key);
...
//    }
     ...
     */
    public void putArrListInt(String key, ArrayList<Integer> intList) {
    	checkForNullKey(key);
     ...
     */
    public void putArrListLong(String key, ArrayList<Long> longList) {
        checkForNullKey(key);
     ...
     */
    public void putArrListDouble(String key, ArrayList<Double> doubleList) {
    	checkForNullKey(key);
     ...
     */
    public void putArrListString(String key, ArrayList<String> stringList) {
    	checkForNullKey(key);
     ...
     */
    public void putArrListBoolean(String key, ArrayList<Boolean> boolList) {
    	checkForNullKey(key);
